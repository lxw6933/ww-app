 ...
 * @description: 邮箱号写入excel转换器
 */
@Slf4j
public class EmailConvert implements Converter<String> {
    ...
    public WriteCellData<String> convertToExcelData(String value, ExcelContentProperty contentProperty, GlobalConfiguration globalConfiguration) {
        ...
        return new WriteCellData<>(SensitiveDataType.EMAIL.getDesensitizer().apply(value));
    }
