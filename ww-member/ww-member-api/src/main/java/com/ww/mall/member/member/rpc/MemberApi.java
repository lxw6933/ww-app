 ...
 * @description:
 */
@FeignClient(value = "ww-member", fallbackFactory = MemberApiFallBack.class)
public interface MemberApi {
     ...
     * @return MemberDTO
     */
    @GetMapping("/ww-member/member/inner/getMemberByMobile")
