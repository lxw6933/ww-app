 ...
 */
@Data
@Schema(description = "创建拼团请求")
public class CreateGroupRequest {

    @Schema(description = "活动ID", requiredMode = REQUIRED, example = "ACT123456")
    ...
    @Schema(description = "订单ID", requiredMode = REQUIRED, example = "ORDER20251208123456")
