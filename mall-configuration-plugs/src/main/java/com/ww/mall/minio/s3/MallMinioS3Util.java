...
public class MallMinioS3Util {
    ...
    public Map<String, Object> chunkFileUpload(String uploadId,
        ...
        try {
            for (int i = 1; i <= chunkNumber; i++) {
                ...
                String uploadUrl = mallMinioS3Client.getPresignedObjectUrl(
    ...
    public boolean mergeChunkFile(String chunkBucketName,
        ...
        try {
            // 查询uploadId上传的所有分片文件
            ListPartsResponse partResult = mallMinioS3Client.listMultipart(chunkBucketName, null, chunkFileName, MAX_CHUNK_NUMBER, 0, uploadId, null, null);
            int partNumber = 1;
    ...
    public List<Integer> getChunkFile(String md5, String chunkFileName, String uploadId) {
        ...
        try {
            // 查询上传后的分片数据
            ListPartsResponse partResult = mallMinioS3Client.listMultipart(md5, null, chunkFileName, MAX_CHUNK_NUMBER, 0, uploadId, null, null);
