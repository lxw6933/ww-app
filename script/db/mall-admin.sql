...
(
    ...
    `username`     varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名（账号名称）',
    `nickname`     varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户昵称（姓名）',
...
(
    ...
    `role_no`     varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '角色编号',
    `remark`      varchar(255)                                           DEFAULT NULL COMMENT '备注',
    `valid`       tinyint(1)                                             DEFAULT NULL COMMENT '是否有效',
    `version`     bigint                                                 DEFAULT NULL,
    `creator_id`  bigint                                                 DEFAULT NULL,
