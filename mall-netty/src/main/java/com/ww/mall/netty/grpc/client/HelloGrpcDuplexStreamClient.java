 ...
 */
@Slf4j
public class HelloGrpcDuplexStreamClient {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 1.rpc远程调用
            StreamObserver<HelloProto.HelloRequest> helloRequestStreamObserver = streamClientHelloService.duplexStreamHello(new StreamObserver<HelloProto.HelloResponse>() {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                builder.setName("client duplex stream消息" + i);
