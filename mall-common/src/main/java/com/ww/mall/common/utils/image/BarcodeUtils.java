package com.ww.mall.common.utils.image;
...
//    =====================================
    ...
    public static void main(String[] args) throws IOException, WriterException {
        Thumbnails.Builder<BufferedImage> widthLogo = createWidthLogo("66", BARCODE_WIDTH, BARCODE_HEIGHT, FORMAT, ENCODE_HINTS);
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        ObjectOutputStream o = new ObjectOutputStream(outputStream);
        o.writeObject(widthLogo);
    }
