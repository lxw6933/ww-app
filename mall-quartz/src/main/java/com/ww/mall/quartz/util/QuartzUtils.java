package com.ww.mall.quartz.util;
    ...
    public static Object invokeMethod(Object obj, Class clazz,
        ...
        for (int i = 0; i < parameterTypes.length; i++) {
            if (null != parameterTypes[i].getComponentType()) {
                ...
                if (parameterTypes[i].getComponentType().getName().equals("int")) {
                    parameterObjects[i] = warpParameter_int(p);
                }
                else if (parameterTypes[i].getComponentType().getName().equals("long")) {
