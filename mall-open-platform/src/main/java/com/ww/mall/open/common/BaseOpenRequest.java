package com.ww.mall.open.common;
...
public class BaseOpenRequest<T> {
    ...
    private void verifyReqSign(String publicKey) {
        String reqData = this.sysCode + this.appCode + this.transId + JSON.toJSON(data);
    ...
    public static void main(String[] args) {
        ...
        String reqData = req.getSysCode() + req.getAppCode() + req.getTransId() + JSON.toJSON(req.getData());
        log.info("商户：{}", reqData);
