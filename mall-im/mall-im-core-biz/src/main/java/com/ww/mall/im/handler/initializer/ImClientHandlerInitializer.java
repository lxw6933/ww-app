...
import com.ww.mall.im.handler.client.ImMsgClientHandler;
...
@Slf4j
@Component
public class ImClientHandlerInitializer extends ChannelInitializer<SocketChannel> {
...
//        ch.pipeline().addLast(new IdleStateHandler(0, imProperties.getClientHeartbeatTime(), 0));
                    /*
                    ################################################################
